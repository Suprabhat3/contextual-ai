...
const GoogleIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 B24 24" fill="currentColor">
...
const SignUpPage: React.FC = () => {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // **FIX: Redirect to login page with a notification flag**
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      // Redirect to homepage on success, as Google accounts are pre-verified
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="bg-slate-800/60 backdrop-blur-lg border border-slate-700 rounded-2xl p-8 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400 mt-2">Join to start chatting with your documents</p>
          </div>
